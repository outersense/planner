...
class ObstacleLatcher:
    ...
    # Calculate the length of the new message
        ...
        idx = self.find_largest_or_999(deque_lengths,new_msg_length)
    ...
    def find_largest_or_999(self,numbers, new_number):

        if all(new_number >= num for num in numbers):
            return 999
        else:
            # Find the index of the most recent largest number
            largest_index = 0
