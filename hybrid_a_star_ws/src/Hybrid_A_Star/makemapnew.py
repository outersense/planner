...
ln2toedit_index3 = np.where((ln2[:,0]>5.5)& (ln2[:,0]<6.75) & (ln2[:,1]>0.98)&(ln2[:,1]<1.25))
...
ln2[ln2toedit_index3[0]] = ln2[ln2toedit_index3[0]] + np.asarray([0,0.15])
# print(ln1[ln1toedit_index[0]][:,0])
# print(ln1)
# print(ln2)
...
waypoints[waypointsedit6[0]] = waypoints[waypointsedit6[0]]+ np.asarray([0,0.10,0])
